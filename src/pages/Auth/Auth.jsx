  ...
  return (
    <section className='auth-section'>
      ...
      <div className='auth-container-2'>
         { !isSignup && <img src={icon} alt='stack overflow' className='login-logo' height='100px' width='100px'/>}
         <form onSubmit={handleSubmit}>
          ...
          <label htmlFor="password">
            ...
            { isSignup && <p style={{color:'#666767', fontSize:'13px'}}>Passwords must contain at least eight<br/> characters, 
