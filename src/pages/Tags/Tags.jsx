...
const Tags = () => {
    ...
    const tagsList = [{
        id: 1,
        tagName: "javascript",
        tagDesc: "For questions regarding programming in ECMAScript (JavaScript/35) and its various dialects/implementations (exculding ActionScript). Please include all relevant tags on your question"
    },{ id: 2,
        tagName: "python",
        tagDesc: "Python is a multi-paradigm, dynamically typed, multipurpose programming language. It is designed to be quick to learn, Understand, and use, and enforce a clean and uniform syntax."
    },{ id: 3,
        tagName: "c#",
        ...
        tagName: "java",
        tagDesc: "Java is a high-level object oriented programming language. Use this tag when you're having problems using or Understand the language itself."
    },{ id: 5,
        tagName: "php",
        ...
        tagName: "html",
        tagDesc: "HTML (HyperText Markup Language) is the markup language for creating web pages and other information to be displayed in aweb browser."
    },{ id: 7,
        tagName: "android", 
        ...
        tagName: "node.js",
        tagDesc: "Node.js is an event-based, non-blocking, asynchronous 1/0 runtime that uses Google's V8 JavaScript engine and libuv library."
    }]
  return (
    <div className='home-container-1'>
        ...
        <p className='tags-p'>A tag is a keyword or label that categorizes your question with other, similer questions.</p>
